...
)
{
	...
	if (!TextParamLoader::LoadTextParam(&g_StageData.TextParam, "Data\\Stage\\Param.txt"))
	{
		return false;
	}

	// 全ステージ数を取得
	g_StageData.TotalStageNum = TextParamLoader::GetTextParamInt(&g_StageData.TextParam, "StageNum");
